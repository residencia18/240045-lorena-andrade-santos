...
export class BancoService {
  ...
  apagarTodosAtendimentos() {
    return this.http.delete('https://petshop-9fb48-default-rtdb.firebaseio.com/atendimento.json');
  }

  getAtendimento(id: string) {
    return this.http.get<Atendimento>(
      `https://petshop-9fb48-default-rtdb.firebaseio.com/atendimento/${id}.json`
    );
  }
